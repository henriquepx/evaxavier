...
export function Hero() {
  return (
    <section className="relative min-h-[90dvh] w-full flex items-center overflow-hidden bg-[#F8F6F2]">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center min-h-[50dvh] py-32">
